...
<html lang="en">
  <head>
    ...
    <title>LEARNING MANAGEMENT SYSTEM - SMK 5 BEKASI</title>
												...
												<div class="box-body">
													...
													<div class="form-group">
													  ...
													  <select name="tingkat" id="" class="form-control">
														<option value="7" <?php if($row['tingkat']=='7') echo 'selected="selected"'; ?>>Kelas 7</option>
														<option value="8" <?php if($row['tingkat']=='8') echo 'selected="selected"'; ?>>Kelas 8</option>
														<option value="9" <?php if($row['tingkat']=='9') echo 'selected="selected"'; ?>>Kelas 9</option>
													  </select>
													</div>
													<div class="form-group">
