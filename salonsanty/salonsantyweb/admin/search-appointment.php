...
<html>
<head>
<title>Santy Salon || Search Booking</title>
...
<body class="cbp-spmenu-push">
			...
			<div class="main-page">
				<div class="tables">
					...
					<div class="table-responsive bs-example widget-shadow">
						<h4>Search Booking / Name / Contact number:</h4>
	<div class="form-body">
    ...
    echo $msg;
							 ...
							 <div class="form-group"> <label for="exampleInputEmail1">Search by Booking Number</label> <input id="searchdata" type="text" name="searchdata" required="true" class="form-control">
