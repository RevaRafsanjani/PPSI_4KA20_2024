...
<html lang="en">
  <head>
    ...
    <title>e-Learning SMKN 5 Bekasi - Data Admin</title>
				...
				<div class="col-12">
					<div class="box">
						<div class="box-header">
							<h4 class="box-title"><button type="button" class="waves-effect waves-light btn btn-primary mb-5" data-toggle="modal" data-target="#tambah"><i class="fa fa-plus"></i> TAMBAH ADMIN</button></h4>
						</div>
						...
						<?php 	
							...
							if(isset($_POST['tambah'])){
								...
								$input  		= "insert into admin (nama, no_hp, nip, password, kota_lahir, tgl_lahir, gender, status) values ('$nama','$no_hp','$nip','$password','$kota_lahir','$tgl_lahir','$gender','AKTIF')";
								$query_input 	= mysql_query($input);
								if($query_input) {
								$sukses 		= "<div class='callout callout-success'> <strong>Sukses ! Data Admin $nama  berhasil tersimpan di database. </strong></div><br>";
								} else $gagal 	= "<div class='callout callout-danger'> <strong>Oh snap! Tambah Data Admin  GAGAL ! Mohon periksa kembali</strong></div><br>".mysql_error();
							}
						  	...
						  	if(isset($_POST['ubah'])){
								...
								$input  		= "update admin set nama ='" . $nama . "', nip ='" . $nip . "', no_hp ='" . $no_hp . "', kota_lahir ='" . $kota_lahir . "', tgl_lahir ='" . $tgl_lahir . "', gender ='" . $gender . "' where id_admin ='" . $id_admin . "'";
								$query_input 	= mysql_query($input);
								if($query_input) {
								$sukses 		= "<div class='callout callout-success'><strong>Sukses ! Data Admin $nama berhasil dirubah. </strong></div><br>";
								} else $gagal 	= "<div class='callout callout-danger'><strong>Oh snap! Ubah Data Admin GAGAL ! Mohon periksa kembali</strong></div><br>".mysql_error();
							}
						  	...
						  	if(isset($_POST['nonaktifkan'])){
								...
								$input  		= "update admin set status ='NON-AKTIF' where id_admin ='" . $id_admin . "'";
								$query_input 	= mysql_query($input);
								if($query_input) {
								$sukses 		= "<div class='callout callout-success'><strong>Sukses ! Data Admin $nama berhasil dinonaktifkan. </strong></div><br>";
								} else $gagal 	= "<div class='callout callout-danger'><strong>Oh snap! Ubah Status Admin GAGAL ! Mohon periksa kembali</strong></div><br>".mysql_error();
							}
						  	...
						  	if(isset($_POST['aktifkan'])){
								...
								$input  		= "update admin set status ='AKTIF' where id_admin ='" . $id_admin . "'";
								$query_input 	= mysql_query($input);
								if($query_input) {
								$sukses 		= "<div class='callout callout-success'><strong>Sukses ! Data Admin $nama berhasil diaktifkan. </strong></div><br>";
								} else $gagal 	= "<div class='callout callout-danger'><strong>Oh snap! Ubah Status Admin GAGAL ! Mohon periksa kembali</strong></div><br>".mysql_error();
							}
						  	...
						  	if(isset($_POST['hapus'])){
								$nama			= $_POST['nama'];
								$id_admin		= $_POST['id_admin'];
								$input  		= "delete from admin where id_admin ='$id_admin'";
								$query_input 	= mysql_query($input);
								if($query_input) {
								$sukses 		= "<div class='callout callout-success'> <strong>Sukses ! Data Admin $nama berhasil dihapus. </strong></div><br>";
								} else $gagal 	= "<div class='callout callout-danger'><strong>Oh snap! Hapus Data Admin GAGAL ! Mohon periksa kembali</strong></div><br>".mysql_error();
							}
								...
								<tbody>
									  ...
									  <div class="modal-dialog" role="document">
										<div class="modal-content">
										  ...
										  <div class="modal-body">
											<form class="form" method="post" action="">
												<div class="box-body">
													<h5>Yakin akan mengaktifkan kembali admin <strong><?php echo $row['nama']; ?></strong> ?</h5>
													<input type="hidden" name="id_admin" value="<?php echo $row['id_admin']; ?>">
									...
									<div class="modal fade" id="nonaktif<?php echo $no; ?>">
									  <div class="modal-dialog" role="document">
										<div class="modal-content">
										  <div class="modal-header">
											<h4 class="modal-title">Nonaktifkan Admin</h4>
											<button type="button" class="close" data-dismiss="modal" aria-label="Close">
											  <span aria-hidden="true">&times;</span></button>
										  </div>
										  <div class="modal-body">
											<form class="form" method="post" action="">
												<div class="box-body">
													<h5>Yakin akan menonaktifkan admin <strong><?php echo $row['nama']; ?></strong> ?</h5>
													<input type="hidden" name="id_admin" value="<?php echo $row['id_admin']; ?>">
													<input type="hidden" name="nama" value="<?php echo $row['nama']; ?>">
												</div> 
										  </div>
									  ...
									  <div class="modal-dialog" role="document">
										<div class="modal-content">
										  ...
										  <div class="modal-body">
											<form class="form" method="post" action="">
												<div class="box-body">
													<h5>Yakin akan menghapus admin <strong><?php echo $row['nama']; ?></strong> ?</h5>
													<input type="hidden" name="id_admin" value="<?php echo $row['id_admin']; ?>">
													<input type="hidden" name="nama" value="<?php echo $row['nama']; ?>">
												</div> 
										  </div>
