...
<head>
  <meta charset="utf-8">
    ...
    <title>e-Learning SMKN 5 Bekasi - Masuk Guru</title>
					...
					<div class="col-lg-4 col-md-5 col-12">
						<div class="bg-white-10 rounded5">
							<div class="content-top-agile p-10 pb-0">
								...
								<h2 class="text-white">LOGIN GURU</h2>		
								<?php 
									if(isset($_POST['login'])){
										...
										if($query){
											...
											if($row > 0){
												...
												echo 				
												"<div class='text-white' align='center'> <i data-feather='alert-octagon' class='w-6 h-6 mr-2'></i> LOGIN GAGAL! NIP/PASSWORD ANDA SALAH! </div>";
												}
											}
