...
<head>
  <meta charset="utf-8">
    ...
    <title>e-Learning SMKN 5 Bekasi - Detail</title>
									  ...
									  <div class="modal-dialog" role="document">
										<div class="modal-content">
										  ...
										  <div class="modal-footer">
											...
											<button type="submit" name="tambah" class="btn btn-rounded btn-primary float-right">Submit</button>
										  </div>
										  </form>
										</div>
									  </div>
								...
								<div class="box-header" align="center">
									<?php
										...
										<h4 class="box-title">KUIS INI SUDAH DIMULAI! <br><br>
											<?php
												$query2 = mysql_query("select count(*) as hasil from detail_materi where id_materi='". $_GET['id_materi'] ."'");
												while ($row2 = mysql_fetch_array($query2)) {
													$jumlahmateri = $row2['hasil'];
												}
												$query2 = mysql_query("select count(*) as hasil from status_materi inner join detail_materi on status_materi.id_detail=detail_materi.id_detail where detail_materi.id_materi='". $_GET['id_materi'] ."'");
												while ($row2 = mysql_fetch_array($query2)) {
													$jumlahkerja = $row2['hasil'];
												}
												...
												if ($balan > 0) {
													...
													$query1 = mysql_query("select * from hasil where id_siswa='" . $_SESSION['id_siswa'] . "'");
