...
<html lang="en">
  <head>
    ...
    <title>e-Learning SMKN 5 Bekasi - Dashboard Admin</title>
		...
		<section class="content">
		  ...
		  <div class="row">
				  <div class="col-lg-3 col-6">
					  <a class="box box-link-shadow text-center" href="admin.php">
						<div class="box-body">
							<?php
								$query = mysql_query("select count(*) as hasil from admin");
						...
						<div class="box-body bg-info">
							<p>
								<span class="mdi mdi-account-key font-size-30"></span>
							</p>
						</div>
					  </a>
				  </div>
				  <div class="col-lg-3 col-6">
					  <a class="box box-link-shadow text-center" href="guru.php">
						<div class="box-body">
							<?php
								$query = mysql_query("select count(*) as hasil from guru");
								while ($row = mysql_fetch_array($query)) {
							?>
							<div class="font-size-24"><?php echo $row['hasil']; ?></div>
							<?php } ?>
						...
						<div class="box-body bg-warning">
							<p>
								<span class="mdi mdi-account-star font-size-30"></span>
							</p>
						</div>
					  </a>
				  </div>
				  <div class="col-lg-3 col-6">
					  <a class="box box-link-shadow text-center" href="siswa.php">
						<div class="box-body">
							<?php
