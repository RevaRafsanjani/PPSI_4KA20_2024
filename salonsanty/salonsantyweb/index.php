...
if(isset($_POST['submit']))
{
    ...
    if ($query) {
        ...
        $message = "Hello, I have made an appointment with the following details:\n";
        $message .= "Name: $name\n";
        $message .= "Email: $email\n";
        $message .= "Phone: $phone\n";
        ...
        // WhatsApp API URL (replace with your own WhatsApp number)
        $whatsapp_url = "https://wa.me/6285781827279?text=" . urlencode($message);
        
        // JavaScript to open WhatsApp and redirect to thank-you.php after 5 seconds
        echo "<script>
                window.open('$whatsapp_url', '_blank');  // Open WhatsApp in a new tab
                setTimeout(function() { window.location.href = 'thank-you.php'; }, 5000);  // Redirect to thank-you.php after 5 seconds
              </script>";
    } else {
...
<html lang="en">
  <head>
    <title>Santy Salon||Home Page</title>
    	...
    	<div class="container-fluid px-0">
    		<div class="row no-gutters d-md-flex justify-content-end">
    				...
    				<div class="text">
    					...
    					<div class="appointment-wrap">
    						<span class="subheading">Form Booking</span>
								<h3 class="mb-2">Santy Salon</h3>
		    				<form action="#" method="post" class="appointment-form">
			            <div class="row">
			              <div class="col-sm-12">
			                <div class="form-group">
					              <input type="text" class="form-control" id="name" placeholder="Nama" name="name" required="true">
					            </div>
			              </div>
			              <div class="col-sm-12">
			                <div class="form-group">
              ...
              ?>
			              ...
			              <div class="col-sm-12">
			                <div class="form-group">
			                  <input type="text" class="form-control appointment_date" placeholder="Tanggal" name="adate" id='adate' required="true">
			                </div>    
			              </div>
			              <div class="col-sm-12">
			                <div class="form-group">
			                  <input type="text" class="form-control appointment_time" placeholder="Jam" name="atime" id='atime' required="true">
			                </div>
			              </div>
			              <div class="col-sm-12">
			                <div class="form-group">
			                  <input type="text" class="form-control" id="phone" name="phone" placeholder="No. HP" required="true" maxlength="10" pattern="[0-9]+">
			                </div>
			              </div>
				          </div>
				          <div class="form-group">
