				...
				if(isset($_POST['jumlah'])){
														...
														for ($i=0;$i<$jumlah;$i++){
															...
															if (empty($pilihan[$nomor])){
																...
																$query=mysql_query("select * from soal where id_soal='$nomor' and kunci_jawaban='$jawaban'");
															   ...
															   $cek=mysql_num_rows(mysql_query("select id_siswa from hasil where id_siswa='$_SESSION[id_siswa]'"));
