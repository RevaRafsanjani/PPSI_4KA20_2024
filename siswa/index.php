...
<html lang="en">
  <head>
    ...
    <title>e-Learning SMKN 5 Bekasi - Dashboard Siswa</title>
		...
		<section class="content">
		  <div class="row">
				  <div class="col-lg-3 col-6">
					  <a class="box box-link-shadow text-center" href="mapel.php">
						<div class="box-body">
							<?php
								$query = mysql_query("select count(*) as hasil from matpel");
				  ...
				  <div class="col-lg-3 col-6">
					  <a class="box box-link-shadow text-center" href="mapel.php">
						<div class="box-body">
							<?php
								$query = mysql_query("select count(*) as hasil from soal where status='TERBIT'");
								while ($row = mysql_fetch_array($query)) {
							?>
							<div class="font-size-24"><?php echo $row['hasil']; ?></div>
							<?php } ?>
				  ...
				  <div class="col-lg-3 col-6">
					  <a class="box box-link-shadow text-center" href="mapel.php">
						<div class="box-body">
							<?php
								$query = mysql_query("select count(*) as hasil from materi");
								while ($row = mysql_fetch_array($query)) {
							?>
							<div class="font-size-24"><?php echo $row['hasil']; ?></div>
							<?php } ?>
