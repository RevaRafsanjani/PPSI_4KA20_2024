				...
				<div class="col-12">
					<div class="box">
						...
						<div class="box-header">
							<h4 class="box-title"><button type="button" class="waves-effect waves-light btn btn-primary mb-5" data-toggle="modal" data-target="#tambah"><i class="fa fa-plus"></i> TAMBAH KELAS</button></h4>
						</div>
										...
										<div class="form-group">
										  ...
										  <select name="id_guru" id="" class="form-control">
											<?php
												...
												$query1 = mysql_query("select * from wali_kelas where id_guru='". $row['id_guru'] ."'");
