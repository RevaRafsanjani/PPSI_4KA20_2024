			  ...
			  <div class="box box-default">
				...
				<?php 	
							...
							if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
								...
								$gagal 	= "<div class='alert alert-danger' role='alert' align='center'><h3><strong>Oh snap! </strong>Pastikan file yang anda upload berektensi PDF. Mohon periksa kembali</div></h3>".mysql_error();
							}
						}
								...
								<div class="box">
									<div class="box-header">
										...
										<?php
											...
											if($row['status']=='DRAFT'){
										?>
										<h4 class="box-title"><button type="button" class="waves-effect waves-light btn btn-success mb-5" data-toggle="modal" data-target="#mulai"><i class="fa fa-check"></i> MULAI KUIS</button></h4>
										<?php } else { ?>
										<h4 class="box-title"><button type="button" class="waves-effect waves-light btn btn-danger mb-5" data-toggle="modal" data-target="#stop"><i class="fa fa-pause"></i> HENTIKAN KUIS</button></h4>
										<?php }} ?>
									</div>
											...
											<tbody>
												  ...
												  <div class="modal-dialog" role="document">
													<div class="modal-content">
													  ...
													  <div class="modal-body">
														<form class="form" method="post" action="">
															<div class="box-body">
																<h5>Yakin akan memulai kuis? <br><br><strong>Note: Anda tidak dapat menambah atau mengedit soal kembali saat kuis berlangsung</strong></h5>
															</div> 
													  </div>
													  <div class="modal-footer">
														<button type="button" class="btn btn-rounded btn-danger" data-dismiss="modal">Batal</button>
														<button type="submit" name="mulai" class="btn btn-rounded btn-primary float-right">Mulai Kuis</button>
													  </div>
													  </form>
													</div>
												  </div>
												...
												<div class="modal fade" id="stop">
												  <div class="modal-dialog" role="document">
													<div class="modal-content">
													  <div class="modal-header">
														<h4 class="modal-title">Hentikan Kuis</h4>
														<button type="button" class="close" data-dismiss="modal" aria-label="Close">
														  <span aria-hidden="true">&times;</span></button>
													  </div>
													  <div class="modal-body">
														<form class="form" method="post" action="">
															<div class="box-body">
																<h5>Yakin akan menghentikan kuis yang sedang berlangsung? </h5>
															</div> 
													  </div>
													  <div class="modal-footer">
														<button type="button" class="btn btn-rounded btn-danger" data-dismiss="modal">Batal</button>
														<button type="submit" name="stop" class="btn btn-rounded btn-primary float-right">Hentikan Kuis</button>
													  </div>
													  </form>
													</div>
												  </div>
