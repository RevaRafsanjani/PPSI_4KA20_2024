...
<head>
  <meta charset="utf-8">
    ...
    <title>e-Learning SMKN 5 Bekasi - Masuk Siswa</title>
					...
					<div class="col-lg-4 col-md-5 col-12">
						<div class="bg-white-10 rounded5">
							<div class="content-top-agile p-10 pb-0">
								<p><img src="../assets/logosmk.png" width="150" alt=""/></p>
								<h2 class="text-white">LOGIN SISWA</h2>		
								<?php 
									if(isset($_POST['login'])){
										...
										if($query){
											...
											if($row > 0){
												...
												echo 				
												"<div class='text-white' align='center'> <i data-feather='alert-octagon' class='w-6 h-6 mr-2'></i> LOGIN GAGAL! NISN/PASSWORD ANDA SALAH! </div>";
												}
											}
								...
								<form action="" method="post">
									<div class="form-group">
										<div class="input-group mb-3">
											...
											<input type="text" class="form-control pl-15 bg-transparent text-white plc-white" name="nisn" placeholder="Nomor Induk Sekolah Nasional">
										</div>
									</div>
									<div class="form-group">
										<div class="input-group mb-3">
