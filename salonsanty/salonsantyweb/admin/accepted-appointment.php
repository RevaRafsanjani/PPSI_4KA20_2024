...
<html>
<head>
<title>Santy Salon || Accepted Booking</title>
...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1">Accepted Booking</h3>
					
					
				
					<div class="table-responsive bs-example widget-shadow">
						<h4>Accepted Booking:</h4>
						<table class="table table-bordered"> <thead> <tr> <th>#</th> <th> Booking Number</th> <th>Name</th><th>Mobile Number</th> <th>Tanggal Booking</th><th>Jam Booking</th><th>Action</th> </tr> </thead> <tbody>
<?php
