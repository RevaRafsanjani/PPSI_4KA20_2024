...
<head>
  <meta charset="utf-8">
    ...
    <title>e-Learning SMKN 5 Bekasi - Data Materi</title>
			  ...
			  <div class="box box-default">
				...
				<?php 	
							...
							if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
					  		...
					  		if(isset($_POST['tambah'])){
								...
								$query	= "insert into materi (tanggal, detail, judul, id_matpel, id_guru) values (NOW(),'$detail','$judul','$idmatpel','". $_SESSION['id_guru'] ."')";
								$query_input 	= mysql_query($query);
								if($query){
									$sukses 	= "<div class='alert alert-info' role='alert' align='center'><h3><strong>Well done! </strong>Data Materi berhasil tersimpan di database.</div></h3>";
								}else{
				...
				<div class="box-body">
					<ul class="nav nav-tabs" role="tablist">
						...
						<li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#siswa" role="tab"><span><i class="ion-email mr-15"></i>DAFTAR SISWA</span></a> </li>
					</ul>
							...
							<div class="col-12">
								<div class="box">
									<div class="box-header">
										<h4 class="box-title"><button type="button" class="waves-effect waves-light btn btn-primary mb-5" data-toggle="modal" data-target="#tambah"><i class="fa fa-plus"></i> TAMBAH MATERI</button></h4>
									</div>
										...
										<div class="table-responsive">
										  <table id="example1" class="table table-bordered table-striped">
											...
											<tbody>
													...
													<td>
														<div class="btn-group mb-5">
														  ...
														  <div class="dropdown-menu">
															<a class="dropdown-item" href="diskusi.php?id_kelas=<?php echo $_GET['id_kelas']; ?>&id_materi=<?php echo $row['id_materi']; ?>">LIHAT DETAIL</a>
													  ...
													  <div class="modal-body">
														<form class="form" method="post" action="">
															<div class="box-body">
																<div class="form-group">
																  <label>Judul Materi</label>
																  <input type="text" class="form-control" name="judul" required value="<?php echo $row['judul']; ?>">
																</div>
																<div class="form-group">
																  <label>Detail Materi</label>
																	<textarea name="detail" class="form-control" id="" cols="30" rows="10" required><?php echo $row['detail']; ?></textarea>
																</div>
												...
												<div class="modal fade" id="berkas<?php echo $no; ?>">
												  <div class="modal-dialog" role="document">
													<div class="modal-content">
													  <div class="modal-header">
														<h4 class="modal-title">Edit Berkas Materi</h4>
														<button type="button" class="close" data-dismiss="modal" aria-label="Close">
														  <span aria-hidden="true">&times;</span></button>
													  </div>
													  <div class="modal-body">
													  ...
													  <div class="modal-footer">
														<button type="button" class="btn btn-rounded btn-danger" data-dismiss="modal">Batal</button>
														<button type="submit" name="berkas" class="btn btn-rounded btn-primary float-right">Simpan</button>
													  </div>
													  </form>
													</div>
												  </div>
												...
												<div class="modal fade" id="hapus<?php echo $no; ?>">
												  <div class="modal-dialog" role="document">
													<div class="modal-content">
													  <div class="modal-header">
														<h4 class="modal-title">Hapus Data Materi</h4>
														<button type="button" class="close" data-dismiss="modal" aria-label="Close">
														  <span aria-hidden="true">&times;</span></button>
													  </div>
													  <div class="modal-body">
														<form class="form" method="post" action="">
															<div class="box-body">
																<h5>Yakin akan menghapus materi <strong><?php echo $row['judul']; ?></strong> ?</h5>
																<input type="hidden" name="id_materi" value="<?php echo $row['id_materi']; ?>">
															</div> 
													  </div>
													  <div class="modal-footer">
